...

    ...
    /// <summary>Core of the F language interpreter</summary>
    public class Interp {
        ...
        public Interp() {
            Globals[TSym] = TSym;
            Def("head", 1, a => (a[0] as Cell)?.Car);
            Def("tail", 1, a => (a[0] as Cell)?.Cdr);
            ...
            Def("less", 2, a => (Arith.Compare(a[0], a[1]) < 0) ? TSym : null);
            ...
            Def("plus", -1, a => FoldL((object) 0, (Cell) a[0],
                                    (i, j) => Arith.Add(i, j)));
            Def("times", -1, a => FoldL((object) 1, (Cell) a[0],
            ...
            Def("divide", -3, a => FoldL(Arith.RoundedQuotient(a[0], a[1]),
                                    (Cell) a[2],
        ...
        /// <summary>Define a built-in function by a name, an head,
        /// and a body.</summary>
        public void Def(string name, int carity, BuiltInFuncBody body) {
            Globals[Sym.New(name)] = new BuiltInFunc(name, carity, body);
        }

        /// <summary>Evaluate a F language expression in an environment.</summary>
        ...
        // (prog E1 ... En) => Evaluate E1, ... except for En and return it.
        ...
        // Compile a F language list (macro ...) or (lambda ...).
